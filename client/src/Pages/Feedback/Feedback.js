  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setFormData({
          name: "",
          email: "user@example.com", // Replace with the email (if available) or remove this line
          experience: "",
          areas: "",
          star: 0,
        });
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <input
            ...
            id="email"
            name="email"
            value="user@example.com" // Replace with the email (if available) or remove this line
            // onChange={handleChange}
            style={{
              width: "100%",
              padding: "8px",
