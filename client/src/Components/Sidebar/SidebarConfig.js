...
export const mainu = [
    ...
    { 
      title: "Profile", icon: <CgProfile className="text-2xl mr-5" />, 
    activeIcon: <CgProfile className="text-2xl mr-5" /> 
    },
    { 
      title: "Feedback", icon: <MdOutlineFeedback className="text-2xl mr-5" />, 
    activeIcon: <MdOutlineFeedback className="text-2xl mr-5" /> 
    },
  ];